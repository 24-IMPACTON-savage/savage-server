...
export const saveSenior = async (saveSeniorDto: SaveSeniorDto): Promise<void> => {
...
export const saveWorker = async (saveWorkerDto: SaveWorkerDto): Promise<void> => {
    const {name, address, contact, introduce, country, expr} = saveWorkerDto
